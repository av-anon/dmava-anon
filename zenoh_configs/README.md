...
2. Launch Autoware
     ...
     ros2 launch autoware_launch e2e_simulator.launch.xml vehicle_model:=awsim_labs_vehicle sensor_model:=awsim_labs_sensor_kit map_path:=/home/XXXX/autoware_map/sirc/ launch_vehicle_interface:=true
     ```
